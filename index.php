  ...
  <?php include_once './includes/navbar.php'?>
    ...
    <div class="section-1">
        <div class="Section-1-text-div">
           <h1 class='home-h1' style='margin-top:5%'>Welcome to Online Library</h1>
            <p class='home-top-p' >You can find out your books here.</p>
...
?>
            <div class="image-holder">
                <a href="https://www.iitk.ac.in/esc101/share/downloads/javanotes5.pdf" target="_blank">
...
<?php }}else { echo "No Books Found"; }
    ...
    <script>
        // Get all book images
        var bookImages = document.querySelectorAll('.image-holder img');

        // Add click event listener to each book image
        bookImages.forEach(function(image) {
            image.addEventListener('click', function(event) {
                ...
                window.open('https://www.iitk.ac.in/esc101/share/downloads/javanotes5.pdf', '_blank');
            });
        });
    </script>
</body>
